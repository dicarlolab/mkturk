        ...
        if (taskscreen == "Sample"){
            for (var i=0; i<IMAGES[taskscreen][classlabel].nimages; i++) {
                if (Array.isArray(IMAGES[taskscreen][classlabel].LIGHTS[lt].position.x[i])){
                    IMAGES[taskscreen][classlabel].LIGHTS[lt].position.x[i] = interpParam(IMAGES[taskscreen][classlabel].LIGHTS[lt].position.x[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].LIGHTS[lt].position.y[i])){
                    IMAGES[taskscreen][classlabel].LIGHTS[lt].position.y[i] = interpParam(IMAGES[taskscreen][classlabel].LIGHTS[lt].position.y[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].LIGHTS[lt].position.z[i])){
                    IMAGES[taskscreen][classlabel].LIGHTS[lt].position.z[i] = interpParam(IMAGES[taskscreen][classlabel].LIGHTS[lt].position.z[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1

                if (Array.isArray(IMAGES[taskscreen][classlabel].LIGHTS[lt].visible[i])){
                    IMAGES[taskscreen][classlabel].LIGHTS[lt].visible[i] = interpParam(IMAGES[taskscreen][classlabel].LIGHTS[lt].visible[i],"binary",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel[i]] = 1 
                }
        ...
        if (taskscreen == "Sample"){
            for (var i = 0; i<IMAGES[taskscreen][classlabel].nimages;i++){
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.x[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.x[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.x[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.y[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.y[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.y[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.z[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.z[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].positionTHREEJS.z[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.x[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.x[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.x[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.y[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.y[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.y[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.z[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.z[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].rotationDegrees.z[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].sizeTHREEJS[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].sizeTHREEJS[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].sizeTHREEJS[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].visible[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].visible[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].visible[i],"binary",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                }
                if (Array.isArray(IMAGES[taskscreen][classlabel].OBJECTS[obj].material.opacity[i])){
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].material.opacity[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].material.opacity[i],"continuous",IMAGES[taskscreen][classlabel].durationMS,framerate)
                    FLAGS.moviepersample[classlabel][i] = 1
                ...
                if (typeof IMAGES[taskscreen][classlabel].OBJECTS[obj].morphTarget !="undefined"){
                    ...
                    IMAGES[taskscreen][classlabel].OBJECTS[obj].morphStrength[i] = interpParam(IMAGES[taskscreen][classlabel].OBJECTS[obj].morphStrength[i],"continuous",IMAGES[taskscreen][classlabel].durationMS[0],framerate)
    ...
    if (taskscreen == "Sample"){
        for (var i = 0; i<IMAGES[taskscreen][classlabel].nimages; i++){
            if (Array.isArray(IMAGES[taskscreen][classlabel].IMAGES.imageidx[i])){
                IMAGES[taskscreen][classlabel].IMAGES.imageidx[i] = interpParam(IMAGES[taskscreen][classlabel].IMAGES.imageidx[i],"binary",IMAGES[taskscreen][classlabel].durationMS,framerate)
                FLAGS.moviepersample[classlabel][i] = 1
            }
        }
    }
...
//==== OBJECTS
    for (var obj in IMAGES[taskscreen][classlabel].OBJECTS){
        ...
        //MORPH 
        var morphDelta = chooseArrayElement(IMAGES[taskscreen][classlabel].OBJECTS[obj].morphTargetvertdelta,frame,0)
        var morphStrength = chooseArrayElement(IMAGES[taskscreen][classlabel].OBJECTS[obj].morphStrength,frame,0)
        
        if (morphStrength != undefined && morphDelta != undefined && Number.isInteger(movieframe)){ //calculate delta for the current movieframe, add to the origin to get new vertices
